...
This folder contains Android sample code demonstrating CameraX usage, organized into focused samples for basic camera usage, extensions, ML Kit integration (QR code), and video recording.

- **Basic**: simple CameraX preview + image capture sample.
