...
@UnstableApi
@Sample(
    name = "Transformer and MediaPipe Integration",
    description = "This sample demonstrates using Transformer and MediaPipe to show object detection in a video",
    documentation = "https://developer.android.com/guide/topics/media/transformer",
    tags = ["Transformer"],
)
class TransformerMediaPipeIntegration : Fragment() {
    /**
     *  Android ViewBinding.
     */
