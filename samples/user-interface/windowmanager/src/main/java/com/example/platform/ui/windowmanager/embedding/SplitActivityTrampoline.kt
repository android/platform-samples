...
class SplitActivityTrampoline : SplitActivityBase() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val activityFilters = setOf(ActivityFilter(componentName(
            "com.example.platform.ui.windowmanager.embedding.SplitActivityTrampolineTarget"), null))
        val placeholderIntent = Intent()
        placeholderIntent.component =
            componentName("com.example.platform.ui.windowmanager.embedding.SplitActivityPlaceholder")
        ...
        activityIntent.component = componentName(
            "com.example.platform.ui.windowmanager.embedding.SplitActivityTrampolineTarget")
